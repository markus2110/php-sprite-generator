...
class SpriteGenerator {
    ...
    public function generate() {
        ...
        // get all usable icons
        $itemLocator = new ItemLocator( $this->sourcePath );
        $this->spriteItems = $itemLocator->getItems();
    ...
    private function calculateSpriteSize() {
        ...
        foreach ($this->spriteItems as $itemProp) {
            if ($itemProp['hPosEnd'] > $maxWidth)
                $maxWidth = $itemProp['hPosEnd'];
            if ($itemProp['vPosEnd'] > $maxHeight)
                $maxHeight = $itemProp['vPosEnd'];
        }
